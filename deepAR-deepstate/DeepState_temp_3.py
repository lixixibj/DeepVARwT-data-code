...
save_path='./temp/deepState/'
figure_path='./temp/deepState/forecasts/'
...
for i in range(num_of_forecast):
    ...
    res=deepState(temp_train_data,frequency,seasonality,horizons,str(starting_time),figure_saving_path)
