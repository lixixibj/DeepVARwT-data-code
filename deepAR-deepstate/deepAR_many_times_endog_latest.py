...
#https://aws.amazon.com/cn/blogs/machine-learning/creating-neural-time-series-models-with-gluon-time-series/
...
seasonality=4
level_value=95
#name_of_dataset='endog_data_m3_T193_date.csv'
name_of_dataset='endog_data_m3_T193_date_new.xls'
all_data=pd.read_excel(name_of_dataset)
...
save_path='./endog_data/deepAR/'
figure_path='./endog_data/deepAR/forecasts/'
...
for i in range(num_of_forecast):
    ...
    res=deepAR(temp_train_data,frequency,seasonality,horizons,starting_time,figure_saving_path)
    #result_ids.append(deepAR.remote(temp_train_data,frequency,seasonality,horizons,starting_time,epochs,figure_saving_path))
