...
def compute_log_likelihood(
    ...
    var_cov_innovations_var1=make_var_cov_of_innovations_var1(redusial_parameters, m, order)
    #calculate variance-covariance matrix of first p obs (y_1,...,y_p)
    #var_cov_matrix_for_initial_p_obs: shape(mp*mp), but this variance-covariance matrix is first p obs (y_b,...,y_1) and it needs to be tranformed for (y_1,...,y_p)
