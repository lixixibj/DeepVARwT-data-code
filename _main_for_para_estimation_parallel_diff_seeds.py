...
num_layers=1
iter1=13000
iter2=6000      #changed from 600 2025-09-09
threshould=1e-6     #changed from -5 2025-09-09

data_saving_path='./simulation-study/simulated_data_len800_VAR2_m3/'
res_saving_path='./simulation-study/100-res-090925-diff-seeds-rep/'
#100 estimation
exps=100
...
#save 
pd.DataFrame(coeffs_all).to_csv('./simulation-study/100-res-090925-diff-seeds-rep/all_coeffs_100exps_090925_diff_seeds.csv')
pd.DataFrame(var_cov_all).to_csv('./simulation-study/100-res-090925-diff-seeds-rep/all_var_cov_100exps_090925_diff_seeds.csv')
